...
public class SplashScreen extends JPanel implements ActionListener {
 ...
 public void init() {
  background = new JLabel(new ImageIcon("images\\pyramids.png"));
  background.setBounds(0, 0, 1024, 650);

  sun = new JLabel(new ImageIcon("images\\sun.png"));

  scroll = new JLabel(new ImageIcon("images\\Scroll.png"));

  leftScroll = new JLabel(new ImageIcon("images\\LeftScroll.png"));

  rightScroll = new JLabel(new ImageIcon("images\\RightScroll.png"));

  rolledScroll = new JLabel(new ImageIcon("images\\RolledScroll.png"));
  panel1 = new JPanel();
