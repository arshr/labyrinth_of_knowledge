...
public class PickDifficulty extends Slide {
  ...
  /**This method is used to draw the images onto the panel. It draws the backgruond and all the buttons.*/
  public void init(){
   ...
   mediumButton = new JButton(new ImageIcon("Images\\medium_button.png"));
